...
def cleanup_rooter():
    """Filter out all Cuckoo rooter entries from iptables-save and restore the resulting ruleset."""
    try:
...
def forward_disable(src, dst, ipaddr):
    """Disable forwarding of a specific IP address from one interface into another."""
    run_iptables(
